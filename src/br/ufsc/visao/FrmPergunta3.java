...
public class FrmPergunta3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Deseja liquidez imediata do investimento?");

        jBtnAvancar.setText("Avançar");

        btnGrpValor.add(jRadioButton1);
        jRadioButton1.setText("0 - Liquidez imediata");

        jBtnVoltar.setText("Voltar");

        btnGrpValor.add(jRadioButton2);
        jRadioButton2.setText("1-7 - Dias");

        btnGrpValor.add(jRadioButton3);
        jRadioButton3.setText("8-14 Dias");
